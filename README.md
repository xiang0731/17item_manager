...
- 图片支持“显示大图”预览，预览窗口可放大 / 缩小 / 还原，放大后可拖动查看细节
...
### v1.10.0 — 2026-02-22
#### 新功能
- “编辑物品 / 已购买入库”图片区域新增“显示大图”按钮，可在独立弹窗查看上传图片
- 大图预览弹窗新增“放大 / 缩小 / 还原”三个按钮，并显示当前缩放比例
- 大图放大后支持鼠标拖动浏览，便于查看票据、标签和参数细节

#### 逻辑变更与优化
- 物品编辑弹窗重排为左中右三列对齐，避免图片尺寸挤压名称与分类位置
- “状态”与下方字段间距统一为标准网格间距，和“状态 → 购入渠道”保持一致
- Demo 数据新增带图片样例（办公设备/滤芯/安全用品），默认覆盖大图预览场景
- “帮助文档”与字段提示补充大图预览使用说明（缩放与拖动）

#### bug修复
- 修复无图状态下大图按钮仍可点击的问题，无图时自动禁用
- 修复大图预览缩放后窗口尺寸变化引发的偏移问题，窗口变化时会自动重算
